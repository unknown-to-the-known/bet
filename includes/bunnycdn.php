...
class BunnyCDNStorage
{
    ...
    */
    public $storageZoneName = 'teacher-upload-video';

    /**
        The API access key used for authentication
    */
    public $apiAccessKey = '8aef6e6f-aef9-48bd-8063-43a25f285b173d0d51ba-5720-4573-ab29-986c9dad80ab';

    /**
        The storage zone region code
    */
    private $storageZoneRegion = 'sg';

    /**
        Initializes a new instance of the BunnyCDNStorage class
    */
    public function __construct($storageZoneName, $apiAccessKey, $storageZoneRegion = "sg") 
    {
