...
<?php 
    ...
    if (isset($_FILES['file'])) {
            ...
            if (!isset($error_message_upload)) {
                ...
                if (!isset($error_message_upload)) {
                   $update = mysqli_query($connection, "UPDATE  rev_erp_student_details SET rev_bhagyalakshmi_bond_doc = '$generate_new_name_upload' WHERE tree_id = '$student_uniq_id'");
                }
            }            
        } else {
