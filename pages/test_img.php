...
<?php 
     if(isset($_POST['name']) && isset($_POST['class']) && isset($_POST['sec']) && isset($_POST['subject']) && isset($_POST['school']) && isset($_POST['date']) && isset($_POST['start_time']) && isset($_POST['end_time']) && isset($_POST['format']) && isset($_POST['uniq_identifier']) && isset($_POST['test_mark'])) {
          ...
          $uniq_for_image = htmlspecialchars($_POST['uniq_identifier'], ENT_QUOTES, 'UTF-8');
          $marks = htmlspecialchars($_POST['test_mark'], ENT_QUOTES, 'UTF-8');
          // $pdf = htmlspecialchars($_POST['pdf_link'], ENT_QUOTES, 'UTF-8');
          if ($uniq_for_image == "") {
               $uniq_for_image = '0';
          } else {
               $uniq_for_image == $uniq_for_image;
          }
