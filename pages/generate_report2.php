			...
			<div class="tab-pane fade show active" id="course-pills-tab6" role="tabpanel" aria-labelledby="course-pills-tab-6">
				<div class="row">
					...
					<div class="col-lg-4 d-flex justify-content-end">
						...
						<div class="badge bg-danger bg-opacity-10 text-danger mb-4 fw-bold btn-transition loading" style="float: right; margin-top: -20px; font-size: 12px; cursor: pointer;" id="downloadPDF"><img src="../assets/images/pdf_file.svg" alt="export_pdf" height="30px" width="30px"> Download PDF</div>
					</div>
				</div>
				<div class="loading_msg1"></div>
				<div class="row pdf_success">
					<div class="col-lg-4"></div>
			            <div class="col-lg-4 alert alert-success" role="alert">
			                 <span class="fw-bold">PDF downloaded successfully</span>
			            </div>
		            <div class="col-lg-4"></div>
            	</div>
    ...
    $("#downloadPDF").click(function(event){
       ...
       $.get( "demo.php", function(data) {
       	if( data != ""){
             ...
             $('.pdf_success').show();
             $(".pdf_success").slideUp(4000, function() {
			  }); 
             // $('.pdf_success').slideUp(1000);
       	}
       	else{
...
<script>
    // var element = document.getElementById('divToExport').style.visibility="none";
	function generatePDF() {
      ...
      // var element = document.getElementById('divToExport').style.visibility="hidden"
</script>