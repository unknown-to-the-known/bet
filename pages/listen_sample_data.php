...
<?php   
 ...
 if (isset($_POST['name']) && isset($_POST['option1']) && isset($_POST['option2']) && isset($_POST['option3']) && isset($_POST['option4']) && isset($_POST['radio']) && isset($_POST['teacher_id']) && isset($_POST['teacher_sec']) && isset($_POST['teacher_class']) && isset($_POST['uniq_id'])) {
		...
		$insert_query = "INSERT INTO rev_lsrw_mcq(mcq_question, mcq_opt1, mcq_opt2, mcq_opt3, mcq_opt4, mcq_ans,tree_teacher_id,tree_teacher_class,tree_teacher_sec,rev_uniq_id) values ('$mcq_q', '$opt_1', '$opt_2', '$opt_3', '$opt_4', '$radio', '$teacher_id', '$teacher_class', '$teacher_sec', '$uniq_id')";
