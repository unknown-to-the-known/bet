	...
	<div class="row">
		<div class="col-md-12">
			...
			<table class="table table-bordered text-dark" id="myTable">
			  ...
			  <tbody>
			  	<?php 
			  		$fetch_all_active_bills = mysqli_query($connection, "SELECT * FROM erp_bill WHERE rev_sts = '1' AND rev_academic_year = '$academic_setter' AND rev_paid_to = 'books' AND rev_paid_on BETWEEN '$st_date' AND '$et_date' ORDER BY tree_id DESC");
